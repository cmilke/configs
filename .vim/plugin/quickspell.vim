" All but the last 30 lines of this is spellrotate, from tweekmonster: https://github.com/tweekmonster/spellrotate.vim
...
function Activate_spellmode()
    setlocal spell! spelllang=en_us
    nnoremap <Left> [s
    nnoremap <Right> ]s
    nmap <Up> <Plug>(SpellRotateBackward)
    nmap <Down> <Plug>(SpellRotateForward)
    " This wonky sequence is Ctrl-Down for my terminal
    nnoremap [1;5B zg
endfunction

function Deactivate_spellmode()
    setlocal spell! spelllang=en_us
    unmap <Left>
    unmap <Right>
    unmap <Up>
...
let g:quickspell_spellmode = 0
function Toggle_spellmode()
    if g:quickspell_spellmode
        call Deactivate_spellmode()
        let g:quickspell_spellmode = 0
    else
        call Activate_spellmode()
        let g:quickspell_spellmode = 1
    endif
endfunction

noremap <LEADER>s :call Toggle_spellmode()<cr>
